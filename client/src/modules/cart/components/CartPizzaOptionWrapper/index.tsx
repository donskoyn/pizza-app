    ...
    return (
        <div >
            ...
            <div className={styles.contentItems}>
                {
                    pizzasCart.length > 0 && pizzasCart.map((elementCart, index) => {
                        return (
                            <CartPizzaOption  {...elementCart} index={index} key={index + elementCart.imageUrl + elementCart.size} />
                        )
                    })
                }
            </div>
            <div className={styles.cartBottom}>
                <div className={styles.bottomDetails}>
                    <span> Total pizzas: <b>{useGetCount()} pcs</b> </span>
                    <span> Order price: <b>{useGetPrice()} $</b> </span>
                </div>
