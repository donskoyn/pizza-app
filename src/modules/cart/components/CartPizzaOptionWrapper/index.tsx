...
import { getOptions } from '../../../common/tools/getOptions';
...
const CartPizzaOptionWrapper: React.FC<CartPizzaOptionWrappers> = ({ pizzasCart }): JSX.Element => {
    ...
    const getCountPizzas = getOptions(pizzasCart, 'COUNT');
    const getCountPrice = getOptions(pizzasCart, 'PRICE');
    ...
    return (
        <div >
            <div className={styles.cartTop}>
                <h2 className={styles.contentTitle}><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Card</h2>
                <div className={styles.cartClear} onClick={cleanCard}>
            ...
            <div className={styles.contentItems}>
                {
                    pizzasCart.length > 0 && pizzasCart.map((pizzaCard, index) => {
                        return (
                            <CartPizzaOption  {...pizzaCard} index={index} />
                        )
                    })
                }
            </div>
            <div className={styles.cartBottom}>
                <div className={styles.bottomDetails}>
                    <span> Total pizzas: <b>{getCountPizzas} pcs</b> </span>
                    <span> Order price: <b>{getCountPrice} $</b> </span>
                </div>
...
export default CartPizzaOptionWrapper
